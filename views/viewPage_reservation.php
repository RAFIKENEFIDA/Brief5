...
<body>
    ...
    <header>
        ...
        <div id="booking" class="section mb-5">
            <div class="section-center  mb-5">
                <div class="container">
                    <div class="row">
                        <div class="booking-form">
                            ...
                            <form action="" method="POST">
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group"> <input name="date_entrer" class="form-control"
                                                type="date">
                                            <span class="form-label">Check In</span>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group"> <input name="date_sortie" class="form-control"
                                                type="date">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="row ">
                                            ...
                                            <div class="form-group"> <select name="localSelected"
                                                    class="form-control selectLocale">
                                        ...
                                        <div class="row Spension">
                                            <div class="form-group"> <select name="pensionSelected"
                                                    class="form-control selectPension">
